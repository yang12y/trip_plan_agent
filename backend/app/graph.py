...
graph.add_edge("path_plan", END)
app = graph.compile()

# 初始化状态
initial_state = TravelPlanState(
    user_id="user1",
    messages=[HumanMessage(content="从上海去北京，1月1-3日，2成人1小孩，喜欢文化、自然、美食，在酒店住宿，最好做高铁")]
)

updated_state = asyncio.run(app.ainvoke(initial_state))

print(updated_state['driving_trip_path'])
print(updated_state['transit_integrated_trip_path'])
print(updated_state['bicycling_trip_path'])
print(updated_state['walking_trip_path'])